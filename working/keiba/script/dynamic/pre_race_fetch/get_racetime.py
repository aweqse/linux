...
def get_url(datetime_array):
    ...
    #テスト用のURL
    #load_url="https://race.netkeiba.com/top/race_list.html?kaisai_date=20250615"
...
def process_date(starttime_array,match_check_word,day, month, year, week_now ):
    ...
    while len(starttime_array)>split_count:
        ...
        #時刻の場合取り出して30分前、１０分前、５分前を算出して配列に挿入する
            ...
            #配列に挿入する
            add_array.extend([year,month,day,week_now,kai,nitime,place_cache,before_30minute, before_10minute, before_5minute,starttime,race_id])
